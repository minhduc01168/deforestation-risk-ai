...
export default function PublicationPage() {
  ...
  return (
    <div className="min-h-screen bg-[#002818] text-[#f8fafc] pt-16 pb-20 relative overflow-x-hidden font-sans">
      {/* GRID TEXTURE */}
      <div 
      ...
      <div className="relative pt-16 pb-14 px-6 text-center overflow-hidden max-w-4xl mx-auto">
        ...
        <p className="text-emerald-100/70 text-base md:text-lg max-w-[520px] mx-auto mb-14 font-normal leading-relaxed">
          {isVi
        ...
        <div className="flex justify-center max-w-[520px] mx-auto rounded-xl overflow-hidden border border-[#005e38]/50 bg-[#003822]/80 shadow-lg">
          <div className="flex-1 p-5 border-r border-[#005e38]/50 text-center">
            ...
            <div className="font-mono text-[10px] text-emerald-200/70 tracking-[0.08em] uppercase font-semibold">Published</div>
          </div>
          <div className="flex-1 p-5 border-r border-[#005e38]/50 text-center">
            <div className="text-3xl md:text-4xl font-extrabold text-[#F4D668] leading-none mb-1">Q1</div>
            <div className="font-mono text-[10px] text-emerald-200/70 tracking-[0.08em] uppercase font-semibold">Journal rank</div>
          </div>
          <div className="flex-1 p-5 text-center">
            <div className="text-3xl md:text-4xl font-extrabold text-[#F4D668] leading-none mb-1">2+</div>
            <div className="font-mono text-[10px] text-emerald-200/70 tracking-[0.08em] uppercase font-semibold">In pipeline</div>
          </div>
        </div>
      </div>
      ...
      <section className="max-w-[900px] mx-auto px-6 pb-20 relative z-10">
        ...
        <div className="mb-8 max-w-[520px]">
          <div className="font-mono text-[10px] text-emerald-200/70 tracking-[0.1em] uppercase mb-2 font-medium">
            Chọn bài nghiên cứu
          </div>
          ...
          <div className="font-mono text-[11px] text-emerald-200/70 mt-1.5 font-medium">
        ...
        {(selectedPaper === 'all' || selectedPaper === 'paper-1') && (
          <div className={`bg-[#003822] border rounded-2xl p-7 md:p-8 mb-4 transition-colors ${paper1Expanded ? 'border-[#F4D668]' : 'border-[#005e38]/60 hover:border-[#005e38]'}`}>
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start gap-4 mb-4">
              ...
              <span className="font-mono text-xs text-emerald-200/70">2025</span>
            </div>
            ...
            <div className="text-xs md:text-sm text-emerald-100/70 mb-4 font-normal">
            ...
            {/* Meta Info Dots */}
            <div className="flex flex-wrap gap-x-6 gap-y-2 font-mono text-[11px] text-emerald-200/70 mb-5 font-medium">
              ...
              <div className="mt-5 border-t border-[#005e38]/40 pt-5">
                    ...
                    <button
                      ...
                      className={`px-4.5 py-2 text-xs md:text-sm font-semibold transition-colors border-b-2 whitespace-nowrap bg-none cursor-pointer ${
                        activeTab === tId
                          ...
                          : 'text-emerald-200/60 border-transparent hover:text-white'
                      }`}
                    >
                  ...
                  <div>
                    <div className="flex gap-2 mb-4">
                      <button
                        ...
                        className={`font-mono text-[11px] px-2.5 py-1 rounded border font-semibold transition-colors cursor-pointer ${
                          abstractLang === 'en' ? 'text-[#F4D668] border-[#005e38] bg-[#005e38]/30' : 'text-emerald-200/60 border-[#005e38]/40'
                        }`}
                      >
                        EN
                      </button>
                      <button
                        ...
                        className={`font-mono text-[11px] px-2.5 py-1 rounded border font-semibold transition-colors cursor-pointer ${
                          abstractLang === 'vi' ? 'text-[#F4D668] border-[#005e38] bg-[#005e38]/30' : 'text-emerald-200/60 border-[#005e38]/40'
                        }`}
                      >
                        VI
                      </button>
                    ...
                    {abstractLang === 'en' ? (
                      <p className="text-emerald-100/70 text-sm leading-[1.75] max-w-[700px] mb-4 font-normal">
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-4">
                      <div className="bg-[#002818]/70 border border-[#005e38]/60 rounded-xl p-4 text-center">
                        ...
                        <div className="text-[11px] text-emerald-200/70 leading-tight">AUC · Random Forest<br />Internal split</div>
                      </div>
                      <div className="bg-[#002818]/70 border border-[#005e38]/60 rounded-xl p-4 text-center">
                        <div className="text-2xl font-bold text-[#F4D668] leading-none mb-1">0.767</div>
                        <div className="text-[11px] text-emerald-200/70 leading-tight">AUC · Transfer test<br />K'Bang → Mang Yang</div>
                      </div>
                      <div className="bg-[#002818]/70 border border-[#005e38]/60 rounded-xl p-4 text-center">
                        <div className="text-xl font-bold text-[#c98d26] leading-none mb-1">19.0%</div>
                        <div className="text-[11px] text-emerald-200/70 leading-tight">Capture@10%<br />Logistic Regression</div>
                      </div>
                    </div>
                    ...
                    <div className="overflow-x-auto rounded-lg border border-[#005e38]/50 mb-3">
                      <table className="w-full text-left text-xs min-w-[540px]">
                        ...
                        <tbody className="divide-y divide-[#005e38]/40 text-emerald-100/70">
                    ...
                    <div className="bg-[#002818]/80 border border-[#005e38]/50 rounded-lg p-3 text-xs text-emerald-100/70 leading-relaxed font-normal">
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
                        <div className="bg-[#002818]/70 border border-[#005e38]/50 rounded-lg p-3">
                          <div className="font-mono text-[10px] text-emerald-200/60 mb-1">BASELINE</div>
                          <div className="text-xs font-medium text-white mb-1">Risk Score</div>
                          <div className="text-[11px] text-emerald-200/70">Standardized benchmark — minimal reference</div>
                        </div>
                        <div className="bg-[#002818]/70 border border-[#005e38]/50 rounded-lg p-3">
                          <div className="font-mono text-[10px] text-emerald-200/60 mb-1">INTERPRETABLE</div>
                          <div className="text-xs font-medium text-white mb-1">Logistic Regression</div>
                          <div className="text-[11px] text-emerald-200/70">Coefficients show direction of risk drivers</div>
                        </div>
                        <div className="bg-[#003822] border border-[#F4D668]/50 rounded-lg p-3">
                          ...
                          <div className="text-[11px] text-emerald-200/80">Captures non-linear relationships</div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 mb-2">
                        <div className="bg-[#002818]/70 border border-[#005e38]/50 rounded-lg p-3">
                          ...
                          <div className="text-[11px] text-emerald-200/70">80/20 hold-out within combined sample · N = 1,212 test cells</div>
                        </div>
                        <div className="bg-[#002818]/70 border border-[#005e38]/50 rounded-lg p-3">
                          <div className="text-xs font-medium text-white mb-1">District Transfer Test</div>
                          <div className="text-[11px] text-emerald-200/70">Train K'Bang → test Mang Yang (unseen) · N = 2,000 test cells</div>
                        </div>
                      </div>
                    ...
                    {[
                      ...
                      <div key={idx} className="bg-[#002818]/70 border border-[#005e38]/50 rounded-lg p-3 grid grid-cols-1 md:grid-cols-3 gap-3 items-start">
                        <div>
                          ...
                          <div className="text-[11px] text-emerald-200/70">{ds.desc}</div>
                        </div>
                        <div>
                          <div className="font-mono text-[10px] text-emerald-200/60 mb-1">Variables</div>
                          <code className="font-mono text-[10px] bg-white/10 px-1.5 py-0.5 rounded block text-white leading-relaxed break-all">
                            {ds.vars}
                          </code>
                        </div>
                        <div>
                          <div className="font-mono text-[10px] text-emerald-200/60 mb-1">Role</div>
                          <div className="text-[11px] text-emerald-200/70">{ds.role}</div>
                        </div>
                      </div>
                    ))}
                    <div className="font-mono text-[10px] text-emerald-200/60 mt-2">
                ...
                {activeTab === 'cite' && (
                  <div>
                    ...
                    {citeType === 'apa' ? (
                      <div>
                        <div className="bg-[#002818] border border-[#005e38]/50 rounded-lg p-4 font-mono text-xs text-emerald-100/80 leading-relaxed mb-3">
                      ...
                      <div>
                        <div className="bg-[#002818] border border-[#005e38]/50 rounded-lg p-4 font-mono text-xs text-emerald-100/80 leading-relaxed mb-3 whitespace-pre-wrap break-all">
{`@article{pham2025deforestation,
  ...
  note    = {Q1, Scopus-indexed}
        ...
        {(selectedPaper === 'all' || selectedPaper === 'paper-2') && (
          <div className="bg-[#003822] border border-[#005e38]/60 hover:border-[#005e38] rounded-2xl p-7 md:p-8 mb-4 transition-colors">
            <div className="flex justify-between items-start gap-4 mb-4">
              ...
              <span className="font-mono text-xs text-emerald-200/70">2026</span>
            </div>
            ...
            <div className="text-xs md:text-sm text-emerald-200/60 mb-4 font-normal">
              VIGIL Research Team
            </div>
            <hr className="border-t border-[#005e38]/40 my-4" />
            <div className="flex flex-wrap gap-x-6 gap-y-2 font-mono text-[11px] text-emerald-200/70 mb-5">
              <span className="flex items-center gap-1.5">
      ...
      <div className="max-w-[900px] mx-auto px-6 pb-20">
        ...
        <div className="relative pl-8 border-l border-[#005e38]">
          ...
          <div className="relative pb-10">
            ...
            <div className="text-xs md:text-sm text-emerald-100/70 leading-relaxed mb-2 max-w-[650px]">
          ...
          <div className="relative">
            ...
            <span className="font-mono text-[10px] px-2.5 py-0.5 rounded-full bg-[#005e38]/30 text-emerald-200/70 border border-[#005e38]/50 inline-block font-medium">
              Planned
            </span>
          </div>
        </div>
      ...
      <div className="max-w-[900px] mx-auto px-6 pb-24">
        ...
        <p className="text-emerald-100/70 text-sm mb-6 max-w-[500px]">
